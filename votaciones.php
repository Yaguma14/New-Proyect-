    ...
    <form method="post">
        ...
        <?php while ($candidato = $result_candidatos->fetch_assoc()): ?>
            <div>
                ...
                <label for="candidato_<?php echo $candidato['id']; ?>">
                    <?php echo htmlspecialchars($candidato['nombre']); ?> - <?php echo htmlspecialchars($candidato['cargo']); ?>
                </label>
                <img src="<?php echo htmlspecialchars($candidato['foto']); ?>" alt="Foto de <?php echo htmlspecialchars($candidato['nombre']); ?>" width="100">
        ...
        <?php while ($actividad = $result_actividades->fetch_assoc()): ?>
            <div>
                ...
                <label for="actividad_<?php echo $actividad['id']; ?>">
